  ...
  >
    ...
    >
      <NuxtLink
        ...
        to="/"
        class="hover:text-[#EB5523] transition-colors"
        >Home</NuxtLink
      >
      <NuxtLink
    ...
    <div
      class="w-screen h-screen fixed top-0 left-0 bg-gray-900/50 backdrop-blur-md z-20 items-center justify-center"
    ...
    >
      ...
      >
        <NuxtLink
          to="/"
          class="text-3xl font-bold hover:text-[#EB5523] transition-colors"
