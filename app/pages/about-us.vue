<template>
  <div class="relative h-[50vh] lg:h-screen flex flex-col justify-center items-center">
    ...
    <div class="relative space-y-2 lg:w-1/2 flex flex-col items-center p-4">
      ...
      <NuxtLink to="/our-services" class="group flex flex-row w-fit border-white border rounded-full px-4 py-2 mt-8 text-sm items-center space-x-2 hover:bg-white transition-colors">
  ...
  <div class="max-w-screen h-screen flex flex-col justify-center px-4 py-16 sm:px-8 sm:py-24 text-justify space-y-4">
    <div class="flex flex-col w-full space-y-2">
      <h1 class="text-3xl lg:text-4xl font-bold text-[#EB5523]">Our Vision</h1>
      <p class="text-lg">
    ...
    <hr />
    <div class="flex flex-col w-full space-y-2">
      <h1 class="text-3xl lg:text-4xl font-bold text-[#EB5523]">Our Mission</h1>
