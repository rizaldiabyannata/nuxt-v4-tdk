<template>
  <div class="bg-gray-200 min-h-screen font-sans">
    <div class="flex min-h-screen w-full justify-center items-center p-4">
      <div ref="loginBox" class="flex flex-col lg:flex-row-reverse lg:w-3/5 w-full max-w-4xl h-auto lg:h-[60vh] shadow-2xl rounded-3xl overflow-hidden">
        <div class="relative h-48 lg:h-full lg:w-2/5">
          <NuxtImg src="/img/login-placeholder.png" alt="Halaman Login" class="w-full h-full object-cover" placeholder />
        </div>
        ...
        >
          ...
          <div class="flex flex-col gap-y-4">
            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  name="password"
                  id="password"
                  class="p-3 w-full bg-gray-700 border border-gray-600 text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 transition pr-10"
                  placeholder="••••••••••••••••"
                  required
                />
                <button type="button" @click="togglePasswordVisibility" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-200">
                  <svg v-if="!isPasswordVisible" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <div class="flex w-full justify-end text-[#EB5523]">
              <NuxtLink to="/forgot-password" class="cursor-pointer">Forgot Password?</NuxtLink>
            </div>
          </div>
