<template>
  ...
  <div
    class="max-w-screen min-h-screen flex flex-col justify-center items-center px-8 md:px-32 py-16"
  >
  ...
  <div
    ...
    class="max-w-screen min-h-screen flex flex-col justify-center items-center px-8 md:px-32 py-16 bg-slate-300 gap-8"
  >
    <div class="flex flex-col w-full">
      <p>Our Portfolio</p>
      <h1 class="text-3xl font bold text-[#EB5523]">Lorem Ipsum</h1>
    ...
    <div
      class="flex flex-col lg:flex-row w-full mt-5 justify-center items-center"
    >
      <div
        class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-24 md:grid-cols-2 md:gap-x-6 w-full gap-y-4"
      >
        <portfolio-card
          class="h-5/6"
