<template>
  <div class="w-full h-screen bg-white flex justify-center items-center">
    <div
      class="w-[900px] h-[550px] bg-[url(/img/grafisbg.png)] bg-cover bg-no-repeat rounded-2xl justify-center items-center flex flex-col shadow-lg shadow-gray-400"
    >
      ...
      <div class="w-full flex flex-col px-50 mt-6">
        <label for="otp" class="mb-3 text-xl font-medium text-gray-300"
          >OTP Code</label
        >
        ...
        <p v-if="fullOtp.length === 6" class="mt-4 text-sm text-gray-300">
          Kode OTP Anda: {{ fullOtp }}
        </p>
        <label
          for="password"
          class="mb-2 text-xl font-medium text-gray-300 pt-4"
          >Password</label
        >
        <input
          v-model="password"
        ...
        <div class="h-5 mt-1">
          <p
            ...
            :class="messageClass"
            class="text-md pt-2 font-medium text-white"
          >
            {{ validationMessage }}
          </p>
        </div>
