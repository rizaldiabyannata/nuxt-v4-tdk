  ...
  <div class="space-y-8">
    ...
    <div v-if="tampilanAktif === 'daftar'" class="space-y-8">
      <div class="flex flex-row justify-between items-center w-full">
        ...
        <div class="flex flex-row items-center space-x-4">
          <label class="input input-bordered flex items-center gap-2 rounded-lg">
            <input type="text" class="grow" placeholder="Search" v-model="value" />
      ...
      <div class="space-y-4">
        ...
        <div
          v-if="articleHighlightList && articleHighlightList.length > 0"
    ...
    >
      <form
        @submit.prevent="isEditing ? updateArticle() : submitArticles()"
        class="space-y-6"
      >
        <div>
...
export default {
  ...
  methods: {
    ...
    togglePreview() {
      ...
      const coverImageUrl =
        this.article.coverImage instanceof File
          ? URL.createObjectURL(this.article.coverImage)
