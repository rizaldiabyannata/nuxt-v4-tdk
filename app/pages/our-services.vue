<template>
  <div class="relative min-h-screen flex flex-col justify-center px-4 py-16 sm:px-8 sm:py-24">
    ...
    <div class="relative flex flex-col flex-grow w-full justify-center">
      <div class="flex flex-col w-full md:w-1/2 justify-center items-start">
        <h1 class="font-bold text-3xl md:text-4xl text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</h1>
  ...
  <div class="max-w-screen min-h-screen flex flex-col justify-center px-4 py-16 sm:px-8 sm:py-24 space-y-2">
    <div class="flex flex-col w-full">
      <p class="text-2xl md:text-3xl">Our Services</p>
      <h1 class="text-4xl md:text-5xl font-bold text-[#EB5523]">Lorem Ipsum</h1>
    </div>
    <div class="grid xl:grid-cols-3 grid-cols-1 gap-8 md:grid-cols-1 w-full pt-12">
      ...
      <services-card title="Manajemen Konstruksi" :list="list_3" :image="img_3"/>
    </div>
  </div>
</template>
